/*
	Ctxlog package provides a simple abstraction that allows to implicitly pass diagnostic
	information between layers of abstraction by adopting golang's context pattern.
